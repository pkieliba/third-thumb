function userOptions = projectOptionsFeet(subj, side, mask)
%
% Roni Maimon 9-2017
...
userOptions.outputFile = [curFolder subj '/RSA/RDMs_Feet_' maskType '_' sess '.mat'];
...
userOptions.maskPath = [curFolder, subID ,...
                           filesep,'masks', ...
                           filesep,'[[maskName]]'];
